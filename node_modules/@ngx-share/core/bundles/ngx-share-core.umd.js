(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs/operators/map'), require('rxjs/operators/delay'), require('@angular/common/http'), require('rxjs/operators/catchError'), require('rxjs/operators/take'), require('rxjs/operators/tap'), require('rxjs/observable/empty'), require('rxjs/observable/of')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'rxjs/operators/map', 'rxjs/operators/delay', '@angular/common/http', 'rxjs/operators/catchError', 'rxjs/operators/take', 'rxjs/operators/tap', 'rxjs/observable/empty', 'rxjs/observable/of'], factory) :
	(factory((global['ngx-share'] = global['ngx-share'] || {}, global['ngx-share'].core = {}),global.ng.core,global.ng.common,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.ng.common.http,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable,global.Rx.Observable));
}(this, (function (exports,core,common,map,delay,http,catchError,take,tap,empty,of) { 'use strict';
 ...
 */
var noneOperator = map.map(function (ref) { return ref.prop.share[ref.os] + ref.url; });
/**
 * Meta tags operator - Serialize meta tags in the sharer URL
 */
var metaTagsOperator = map.map(function (ref) {
    /**
 ...
 */
var printOperator = map.map(function (ref) { return ref.window.print(); });
/**
 ...
 */
var pinterestOperator = map.map(function (url) {
...
exports.noneOperator = noneOperator;
exports.metaTagsOperator = metaTagsOperator;
exports.printOperator = printOperator;
exports.pinterestOperator = pinterestOperator;
